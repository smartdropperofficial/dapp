...
const ShippingInfo: React.FC = () => {
     ...
     return (
          <>
               <section id="shipping-type" className="flex-column col-lg-12 col-12 d-lg-flex">
                    <div className="my-4">
                         <div className="d-lg-flex col-12 flex-column">
                              <div className="form-check  col-lg-12">
                                   <input className="form-check-input" type="radio" name="flexRadioDefault" value="address" id="flexRadioDefault1" onChange={DeliveryTypeHandler} checked={shippingType === "address"} />
                                   <label className="form-check-label" htmlFor="flexRadioDefault1">
                                        <b>Deliver to address</b>
                                   </label>
                              </div>
                              <div className="form-check   col-lg-12  my-lg-0 my-3">
                                   <input className="form-check-input" type="radio" name="flexRadioDefault" value="locker" id="flexRadioDefault2" onChange={DeliveryTypeHandler} checked={shippingType === "locker"} disabled={true} />
                              ...
                              <div className="row">
                                   <div className="col-lg-6 mb-4">
                                        <div className="form-group d-flex flex-column">
                                             ...
                                             <input type="text" onChange={(e) => inputHandler(e, "firstName")} value={ctx?.shippingInfo?.firstName} className="form-control mt-2" />
                                   ...
                                   <div className="col-lg-6 mb-4 ">
                                        <div className="form-group d-flex flex-column">
                                             ...
                                             <input type="text" onChange={(e) => inputHandler(e, "lastName")} value={ctx?.shippingInfo?.lastName} className="form-control mt-2" />
                                   ...
                                   <div className="col-12 mb-4">
                                        <div className="form-group d-flex flex-column">
                                             ...
                                             <input type="text" onChange={(e) => inputHandler(e, "addressLine1")} value={ctx.shippingInfo?.addressLine1} className="form-control mt-2" />
                                   ...
                                   <Alert severity="warning" className="col-12 d-flex justify-content-center rounded-3 mt-2">
                                        <AlertTitle className="">
                                             ...
                                             <span>
                                                  ...
                                                  <a href="https://www.amazon.com/gp/help/customer/display.html?ref_=hp_left_v4_sib&nodeId=G201910770" target="_blank" className="text-decoration-line">
