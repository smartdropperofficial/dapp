...
const ModalStatusSteps: React.FC<{ close: () => void; asin: string; amazonStatus: any }> = ({
	close,
	asin,
		...
		<>
			<div className="modal-body">
				...
				{currentStep === OrderStatusSteps.ERROR &&
					<p className="text-center text-danger">AN ERROR HAS OCCURRED, PLEASE CONTACT SUPPORT</p>}
			</div>
...
export default ModalStatusSteps;
