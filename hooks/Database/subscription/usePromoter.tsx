...
const usePromoter = () => {
    ...
    const getAllPromotersSubsByAddressOnDB = useCallback(async (address: string): Promise<PromoterModelSB[]> => {
        if (getDataFromSB) {
            try {
    ...
    const getPromoterOnDB = useCallback(async (promoterAddress: string): Promise<PromoterModelSB | null> => {
        try {
    ...
    const getPromoterByReferralOnDB = useCallback(async (referralCode: string): Promise<PromoterModelSB | null> => {
        try {
    ...
    const addPromoterOnDB = useCallback(async (promoterAddress: string, referral: string): Promise<PromoterModelSB | null> => {
    ...
    const setPromoterActiveOnDB = useCallback(async (promoterAddress: string, isActive: boolean) => {
        if (updateDataOnSB) {
            try {
    ...
    const setPromoterPercentageOnDB = useCallback(async (promoterAddress: string, percentage: number) => {
        if (updateDataOnSB) {
            try {
    ...
    const setPromoterProfitOnDB = useCallback(async (promoterAddress: string, newProfit: number) => {
        if (updateDataOnSB) {
            try {
