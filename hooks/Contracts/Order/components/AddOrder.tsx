...
const AddOrder: React.FC = () => {
    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        setError(null);
        try {
            const res = await createOrderOnWeb3(subscriptionTypeId!, orderId!, session?.address!);
    ...
    return (
        <Form onSubmit={handleSubmit} className="d-flex flex-column">
            ...
            <Form.Group as={Col} controlId="paymentTx" className="my-2">
                ...
                <Form.Control type="text" value={orderId!} onChange={e => setOrderId(e.target.value)} required placeholder="Insert payment Tx" />
            </Form.Group>
            <Form.Group as={Col} controlId="buyer" className="my-2">
                <Form.Label>Buyer Wallet</Form.Label>
                <Form.Control type="text" value={buyer!} onChange={e => setBuyer(e.target.value)} required placeholder="Insert buyer address" />
            </Form.Group>
