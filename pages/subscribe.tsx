...
const Subscribe = () => {
    ...
    const { getLastValidSubscriptionOnBC: getLastValidSubscription, getAllSubsByAddressOnBC } = useSubscriptionManagement();
    ...
    useEffect(() => {
        if (session?.address && address && getAllSubsByAddressOnBC)
            getAllSubsByAddressOnBC(session?.address).then(data => {
                if (data.length > 0) {
    ...
    }, [getAllSubsByAddressOnBC, session?.address, address]);
            ...
            {shouldHydrate && (
                <div className="d-flex col-12 row m-auto ">
                    <section className=" h-100 w-100 d-flex align-items-start justify-content-center flex-column flex-xl-row  ">
                        {!address ? <Card> Connect a wallet</Card> :
                            ...
                            <>
                                <section className="col-12 col-xl-7 p-0 py-xl-3 mx-xl-1 my-3 ">
                                    ...
                                    <section className="mt-5 d-flex table-responsive p-3 " style={{ maxWidth: '100%', backgroundColor: 'white', overflowY: 'auto', maxHeight: '500px' }}>
                                ...
                                <section id="payment-details" className="col-12 col-xl-4 h-100  py-xl-3 my-3 mx-xl-1 sticky-lg-top ">
                                    <Card>
                                        <> {ctx.subscriptionsModels.length < 1 ? <Skeleton height={20} count={6} /> :
                                            <div className={`row  justify-content-evenly d-flex flex-column align-items-center rounded-2`}>
                                                <div className="text-center col-8 col-xl-10  ">
                                                    ...
                                                    {(isBestChoice && ctx.currentSubscription!
                                                        ...
                                                        <>
                                                            <div className="d-flex flex-column justify-content-center align-items-center">
                                                                ...
                                                                >
                                                                    ...
                                                                    <div className="d-flex col-12 flex-column">
                                                                        <div className="col-12 p-1">
                                                                            {ctx.promoterReferral !== '' && loadingReferral ? <Spinner animation="border" role="status" >
                                                                                    ...
                                                                                    ctx.promoterReferral === '' ||
                                                                                        ...
                                                                                        : loadingReferral ?

                                                                                            {
                                                                                                ...
                                                                                                borderColor: !ctx.isReferralCodeApplied && !loadingReferral ? 'red' : 'green',
                                                                                                borderWidth: '4px',
                                                                                                backgroundColor: !ctx.isReferralCodeApplied && !loadingReferral ? '' : '#f8d7da',
                                                                                            }
                                                                                }
                                                                            />}
                                                                ...
                                                                <span style={{ color: ctx.isReferralCodeApplied && !loadingReferral ? 'green' : 'red' }}>
                                                                    {(ctx.promoterReferral === '' ||
                                                                        ctx.promoterReferral === undefined ||
                                                                        ctx.promoterReferral === null) && !loadingReferral ? '' :
                                                                        ((ctx.promoterReferral !== '' ||
                                                                            ctx.promoterReferral !== undefined ||
                                                                            ctx.promoterReferral !== null) && loadingReferral) ? '' :
                                                                            !loadingReferral && !ctx.isReferralCodeApplied ? 'Referral code not valid!' : 'Referral code valid!'
                                                                ...
                                                                <div className="w-100 d-flex justify-content-center align-content-center flex-column">
                                                                    ...
                                                                    <PaySubscription
                                                                        ...
                                                                        setIsReferralCodeApplied={(subType: boolean) => ctx.setIsReferralCodeAppliedHandler(subType)}
                                                        ...
                                                        <div>
                                                            <PaySubscription Package={ctx.selectedPackage!} btnStyle={{ backgroundColor: '#00a60c', color: '#fff' }} />
                                                        </div>
                                                    )}
                                                </div>
                                                ...
                                                <div className={`col-12 col-xl-10 text-center `}>
                                                    ...
                                                    <div className="">
                                                        {ctx.subscriptionsModels.length < 1 ? <Skeleton height={20} count={6} /> : <Alert className="alert-warning">
                                                            <AlertTitle>
                                                                Remember, <u>you cannot use multiple coins in a single payment. </u> <br />
                                                                At least one coin on your wallet must have sufficient credit to cover the whole order amount. Otherwise you
                                                                will get the error: <strong className=""> No payment option found!</strong>
                                                            </AlertTitle>
                                                            <br />
